...
public class Release implements org.apache.thrift.TBase<Release, Release._Fields>, java.io.Serializable, Cloneable, Comparable<Release> {
  ...
  static {
    schemes.put(StandardScheme.class, new ReleaseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReleaseTupleSchemeFactory());
  }
  ...
  public Release setRqid(String rqid) {
    this.rqid = rqid;
    return this;
  }
  ...
  public Release setRpid(int rpid) {
    this.rpid = rpid;
    setRpidIsSet(true);
    return this;
  }
  ...
  private static class ReleaseStandardSchemeFactory implements SchemeFactory {
    public ReleaseStandardScheme getScheme() {
      return new ReleaseStandardScheme();
    }
  }

  private static class ReleaseStandardScheme extends StandardScheme<Release> {
  ...
  private static class ReleaseTupleSchemeFactory implements SchemeFactory {
    public ReleaseTupleScheme getScheme() {
      return new ReleaseTupleScheme();
    }
  }

  private static class ReleaseTupleScheme extends TupleScheme<Release> {
